 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
     <!-- Brand Logo -->
     <a href="../Rh/recursos_humanos.php" class="brand-link">
               ...
               with font-awesome or any other icon font library -->
                 <li class="nav-item">
                     ...
                     <ul class="nav nav-treeview">
                         <li class="nav-item">
                             <a href="../Rh/lista_usuarios.php" class="nav-link active menu-item">
                 ...
                 <li class="nav-item">
                     ...
                     <ul class="nav nav-treeview">
                         <li class="nav-item">
                             <a href="../Rh/solicitudes_vacaciones_rh.php" class="nav-link active menu-item">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Vacaciones</p>
                             </a>
                         </li>
